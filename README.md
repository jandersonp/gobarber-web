...
To see the **api**, click here: [GoBarber Rest API](https://github.com/jandersonp/gobarber-api)</br>
...
- Have this application's [API](https://github.com/jandersonp/gobarber-api) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/jandersonp/gobarber-web && cd gobarber-web
```
...
$ gh repo fork jandersonp/gobarber-web
```
